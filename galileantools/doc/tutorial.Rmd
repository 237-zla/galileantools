---
title: "Galileantools tutorial"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Galileantools tutorial}
...
This vignette demonstrates how to simulate a projectile launched from a moving platform,
apply Galilean transformations, and estimate the platform velocity from noisy measurements
using the `galileantools` package.
